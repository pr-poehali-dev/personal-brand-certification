  ...
  const faqs = [
    {
      ...
      answer: "Мы работаем по системе постоплаты. Вы платите только после получения готовых документов. Это гарантирует вам безопасность и уверенность в результате."
    },
    {
    ...
    },
    {
      ...
      answer: "Да, специализируемся на электронике, оборудовании, медтехнике. Работали с Lenovo, Huawei, Xiaomi. Знаем все тонкости сертификации высокотехнологичных товаров."
    },
    {
